...
## Future Scope
I was inspired to write the blog after going through Andrew Ng's lecture series and especially the article on [neural nets](https://towardsdatascience.com/lets-code-a-neural-network-in-plain-numpy-ae7e74410795) posted by Piotr Skalski on medium. After studying about neural nets, I realized the importance of taking a deep dive into AI models before implementation, and Piotr's article provided me a methodology to understand and implement the models. It will be my aim to implement every model I learn about similarly, along with the usage of optimizers wherever required.
